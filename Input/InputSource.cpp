...
int main()		//Start of main program
{
	...
	cin >> first_name;		//What is this, I have no idea, send halp.	//Apparently the exact opposince to cout, how oblivious am I. Fetch command for what first_name is for next output I'm assuming.
